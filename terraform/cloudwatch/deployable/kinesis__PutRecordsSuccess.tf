...
resource "aws_cloudwatch_metric_alarm" "euw1_cloudwatch_kinesis_put_records_success" {
  ...
  statistic           = "Maximum"
  dimensions = {
    QueueName = var.eu-west-1__kinesis__PutRecordsSuccess[count.index].ResourceName
  }
...
resource "aws_cloudwatch_metric_alarm" "euw2_cloudwatch_kinesis_put_records_success" {
  ...
  statistic           = "Maximum"
  dimensions = {
    QueueName = var.eu-west-2__kinesis__PutRecordsSuccess[count.index].ResourceName
  }
