...
resource "aws_cloudwatch_metric_alarm" "euw1_cloudwatch_sqs_approx_num_of_messages_not_visible" {
  ...
  alarm_name          = "${var.eu-west-1__sqs__ApproximateNumberOfMessagesNotVisible[count.index].ResourceName}_ApproximateNumberOfMessagesNotVisible_alarm"
...
resource "aws_cloudwatch_metric_alarm" "euw2_cloudwatch_sqs_approx_num_of_messages_not_visible" {
  ...
  alarm_name          = "${var.eu-west-2__sqs__ApproximateNumberOfMessagesNotVisible[count.index].ResourceName}_ApproximateNumberOfMessagesNotVisible_alarm"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 2
