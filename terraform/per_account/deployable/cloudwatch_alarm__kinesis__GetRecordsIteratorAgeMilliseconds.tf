...
resource "aws_cloudwatch_metric_alarm" "euw1_cloudwatch_kinesis_get_records_iterator_age_msecs" {
  ...
  alarm_name          = "${var.eu-west-1__kinesis__GetRecordsIteratorAgeMilliseconds[count.index].ResourceName}_GetRecordsIteratorAgeMilliseconds_alarm"
...
resource "aws_cloudwatch_metric_alarm" "euw2_cloudwatch_kinesis_get_records_iterator_age_msecs" {
  ...
  alarm_name          = "${var.eu-west-2__kinesis__GetRecordsIteratorAgeMilliseconds[count.index].ResourceName}_GetRecordsIteratorAgeMilliseconds_alarm"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 2
