...
resource "aws_cloudwatch_metric_alarm" "euw1_cloudwatch_firehose_execute_processing_success" {
  ...
  statistic           = "Maximum"
  dimensions = {
    QueueName = var.eu-west-1__firehose_ExecuteProcessingSuccess[count.index].ResourceName
  }
...
resource "aws_cloudwatch_metric_alarm" "euw2_cloudwatch_firehose_execute_processing_success" {
  ...
  statistic           = "Maximum"
  dimensions = {
    QueueName = var.eu-west-2__firehose_ExecuteProcessingSuccess[count.index].ResourceName
  }
