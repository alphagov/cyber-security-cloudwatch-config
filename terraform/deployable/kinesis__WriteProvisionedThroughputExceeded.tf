...
resource "aws_cloudwatch_metric_alarm" "euw1_cloudwatch_kinesis_write_provision_throughput_exceeded" {
  ...
  statistic           = "Maximum"
  dimensions = {
    QueueName = var.eu-west-1__kinesis_WriteProvisionedThroughputExceeded[count.index].ResourceName
  }
...
resource "aws_cloudwatch_metric_alarm" "euw2_cloudwatch_kinesis_write_provision_throughput_exceeded" {
  ...
  statistic           = "Maximum"
  dimensions = {
    QueueName = var.eu-west-2__kinesis_WriteProvisionedThroughputExceeded[count.index].ResourceName
  }
